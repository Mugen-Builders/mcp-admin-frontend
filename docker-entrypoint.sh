...
# Default matches docker-compose `admin-api` service; Fly sets ADMIN_API_BASE_URL via secrets.
...
url="${ADMIN_API_BASE_URL:-http://admin-api:8000}"
case "$url" in
    http://*|https://*) ;;
